    ...
    public partial class Initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubConsultants", x => x.SubCosultantID);
                    table.ForeignKey(
                        name: "FK_SubConsultants_MainConsultants_mainConsultantMainCosultantID",
                        column: x => x.mainConsultantMainCosultantID,
                        principalTable: "MainConsultants",
                        principalColumn: "MainCosultantID");
                    table.ForeignKey(
                        name: "FK_SubConsultants_ProjectManagers_ProjectManagerID",
                        column: x => x.ProjectManagerID,
                        principalTable: "ProjectManagers",
                        principalColumn: "ProjectManagerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultantBoqs_SubConsultants_SubConsultantID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EngineerInvoices_SubConsultants_subConsultantSubCosultantID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GeneralDrowings_SubConsultants_subConsultantSubCosultantID",
                        column: x => x.subConsultantSubCosultantID,
                        principalTable: "SubConsultants",
                        principalColumn: "SubCosultantID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectSubConsultants_SubConsultants_subConsultantSubCosultantID",
                        column: x => x.subConsultantSubCosultantID,
                        principalTable: "SubConsultants",
                        principalColumn: "SubCosultantID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopDrawings_SubConsultants_subConsultantSubCosultantID",
                        column: x => x.subConsultantSubCosultantID,
                        principalTable: "SubConsultants",
                        principalColumn: "SubCosultantID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubConsultants_mainConsultantMainCosultantID",
                table: "SubConsultants",
                column: "mainConsultantMainCosultantID");

            migrationBuilder.CreateIndex(
                name: "IX_SubConsultants_ProjectManagerID",
                table: "SubConsultants",
                column: "ProjectManagerID");
        }
