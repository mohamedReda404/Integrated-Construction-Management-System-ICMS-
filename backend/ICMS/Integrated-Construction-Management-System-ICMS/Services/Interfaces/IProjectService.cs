...
namespace Integrated_Construction_Management_System_ICMS.Services.Interfaces
{
    ...
    { 
        ...
        Task<int> Conpleted( CancellationToken cancellationToken = default);
        Task<IEnumerable<ProjectResponce>> ActiveProjects(CancellationToken cancellationToken = default);
    }
}
