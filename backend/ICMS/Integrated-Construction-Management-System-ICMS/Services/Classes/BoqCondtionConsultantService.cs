...
{
    public class BoqCondtionConsultantService
        : GenericService<BoqCondtionConsultant>, IBoqCondtionConsultantService
    {
        public BoqCondtionConsultantService(DbContext context)
            : base(context)
        {
        }
    }
